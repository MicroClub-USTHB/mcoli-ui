...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">npm install input-otp lucide-react</Tab>
  <Tab value="pnpm">pnpm add input-otp lucide-react</Tab>
  <Tab value="yarn">yarn add input-otp lucide-react</Tab>
  <Tab value="bun">bun add input-otp lucide-react</Tab>
</Tabs>
