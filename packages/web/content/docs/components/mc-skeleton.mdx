...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">npm install clsx tailwind-merge</Tab>
  <Tab value="pnpm">pnpm add clsx tailwind-merge</Tab>
  <Tab value="yarn">yarn add clsx tailwind-merge</Tab>
  <Tab value="bun">bun add clsx tailwind-merge</Tab>
</Tabs>
