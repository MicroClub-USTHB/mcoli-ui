...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">npm install sonner lucide-react</Tab>
  <Tab value="pnpm">pnpm add sonner lucide-react</Tab>
  <Tab value="yarn">yarn add sonner lucide-react</Tab>
  <Tab value="bun">bun add sonner lucide-react</Tab>
</Tabs>
