...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">npx mcoli-ui@latest add mc-switch</Tab>
  <Tab value="pnpm">pnpm dlx mcoli-ui@latest add mc-switch</Tab>
  <Tab value="yarn">yarn dlx mcoli-ui@latest add mc-switch</Tab>
  <Tab value="bun">bunx mcoli-ui@latest add mc-switch</Tab>
</Tabs>
